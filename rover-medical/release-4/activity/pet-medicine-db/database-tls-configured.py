...
def evaluate(evidence):
    try:
        ...
        actual_references = {
            "ssl_ca": config.get("my-database", "ssl_ca", fallback=None),
            "ssl_cert": config.get("my-database", "ssl_cert", fallback=None),
            "ssl_key": config.get("my-database", "ssl_key", fallback=None)
        }
